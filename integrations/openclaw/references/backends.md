...
|---------|----------|----------|-------------|
| `anthropic-sdk` | Anthropic | General coding, custom tools | `ANTHROPIC_API_KEY` |
| `claude-code` | Anthropic | Battle-tested file ops, native sandbox | Claude Code CLI installed |
| `codex` | OpenAI | OpenAI models (o3, GPT) | `OPENAI_API_KEY` + Codex CLI |
...
- **Models**: Claude Sonnet, Claude Opus, Claude Haiku. Also supports AWS Bedrock.
...
- **Models**: Whatever Claude Code uses (typically Claude Sonnet).
...
- **Models**: o3, GPT-4o, etc. via OpenAI.
